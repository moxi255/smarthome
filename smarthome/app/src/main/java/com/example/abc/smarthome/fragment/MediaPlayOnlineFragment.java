...
public class MediaPlayOnlineFragment extends MediaPlayFragment implements OnClickListener{
	...
	/**
	 * @see com.dahua.hsviewclientopendemo.mediaplay.MediaPlayFragment#onCreate(Bundle)
	 *      描述：
	...
	/**
	 * @see com.dahua.hsviewclientopendemo.mediaplay.MediaPlayFragment#onActivityCreated(Bundle)
	...
	/**
	 * @see com.dahua.hsviewclientopendemo.mediaplay.MediaPlayFragment#resetViews(Configuration)
	 *      描述：实现个性化界面
